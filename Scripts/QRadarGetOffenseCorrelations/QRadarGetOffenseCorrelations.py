...
include_null = bool(demisto.get(d_args, 'include_null_correlations'))

if include_null:
    QUERY = "SELECT *,\"CRE Name\",\"CRE Description\",CATEGORYNAME(highlevelcategory) FROM events WHERE INOFFENSE({0}) START '{1}'"
else:
